...
int main() {
    int totalPopUS2017 = 324309805; // Total poplation at 2017 in the United States
    ...
    cout << "Please enter year which you want: ";
    cin >> yearYouWantKnow;
    totalPopUS = totalPopUS2017 + ((yearYouWantKnow - 2017) * (rateBirthYear + rateDeathYear + rateImmigrationYear + rateNetGainYear));
