...
int main() {
    double valueQuarters = 25;// value of quarters in cents
    double valueDimes = 10;// value of dimes in cents
    double valueNickels = 5;// value of nickels in cents
    double valuePennies = 1;// value of pennies in cents
    double totalCashInCents = 0;// Convert total cash in cents
    double amountQuarters = 0;// count number of coins about quarters
    double amountDimes = 0;// count number of coins about dimes
    double amountNickels = 0;// count number of coins about nickels
    double amountPennies = 0;// count number of coins about pennies
